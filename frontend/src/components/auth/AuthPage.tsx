    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f8f3f1] text-slate-900">
      ...
      <div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-6 py-8 lg:px-8">
        <section className="w-full max-w-md rounded-4xl border border-white/80 bg-white/90 p-6 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
          ...
          {error && (
            <div className="mb-6 flex items-start gap-3 rounded-2xl bg-rose-50 border border-rose-100 p-4 text-xs font-semibold text-rose-600 animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="space-y-2 text-sm font-medium text-slate-700">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-[#fbf9f8] px-4 py-3 focus-within:border-crimson focus-within:bg-white focus-within:ring-2 focus-within:ring-crimson/20">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group inline-flex w-full items-center justify-center gap-2 rounded-2xl mt-4 bg-crimson px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-crimson/20 transition-all hover:bg-crimson-hover hover:shadow-crimson/30 disabled:opacity-75 disabled:cursor-not-allowed cursor-pointer"
            >
              {loading ? (
                <>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            {content.switchLabel}{" "}
            <Link href={content.switchHref} className="font-semibold text-crimson hover:text-crimson-hover">
              {content.switchCta}
            </Link>
          </p>
        </section>
