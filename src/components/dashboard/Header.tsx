...
import { Search, Bell, Plus, Menu, X, Globe, User, LogOut, CheckCircle2 } from "lucide-react";
...
export default function Header({
  ...
  const notifications = [
    { id: 1, text: "Sarah K. shared 'Product Specs V2' with you", time: "10m ago", read: false },
    { id: 2, text: "Marcus V. left a comment in 'Marketing Campaign'", time: "1h ago", read: false },
    { id: 3, text: "System Auto-save successful for 'Sprint Plan'", time: "2h ago", read: true }
  ];
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-crimson ring-2 ring-white animate-pulse" />
          </button>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-48 origin-top-right rounded-xl border border-slate-100 bg-white p-1.5 shadow-2xl ring-1 ring-black/5 animate-fade-in z-50">
              <div className="px-3 py-2 border-b border-slate-100/80 mb-1">
                ...
                <p className="text-[9px] text-slate-400">john.doe@family.com</p>
              </div>
              <button 
                onClick={() => {
                  setShowProfileMenu(false);
